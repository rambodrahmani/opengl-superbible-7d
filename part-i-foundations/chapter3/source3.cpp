...
class source3 : public GLFWApplication
{
	private:
		...
		GLuint compile_shaders()
		{
			...
			string vertex_shader_str = OpenGLUtil::readShader("../../../../../RH-Tests/OpenGL-Superbible-7ED/part-i-foundations/chapter3/shaders/source3_vertex.glsl");
			static const char * vertex_shader_src = vertex_shader_str.c_str();

			// load the source code for the fragment shader
			string fragment_shader_str = OpenGLUtil::readShader("../../../../../RH-Tests/OpenGL-Superbible-7ED/part-i-foundations/chapter3/shaders/source3_fragment.glsl");
	...
	public:
		...
		void render(double currentTime) override
		{
			...
			OpenGLUtil::clearBufferfv(GL_COLOR, 0, red);
			...
			// Update the value of input attribute 0
			glVertexAttrib4fv(1, randomColor);

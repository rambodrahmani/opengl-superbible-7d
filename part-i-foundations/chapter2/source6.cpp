...
class source6 : public GLFWApplication
{
    private:
        ...
        GLuint compile_shaders()
        {
            ...
            string vertex_shader_str = OpenGLUtil::readShader("../../../../../RH-Tests/OpenGL-Superbible-7ED/part-i-foundations/chapter2/shaders/vertex.glsl");
            static const char * vertex_shader_src = vertex_shader_str.c_str();

            // load the source code for the fragment shader
            string fragment_shader_str = OpenGLUtil::readShader("../../../../../RH-Tests/OpenGL-Superbible-7ED/part-i-foundations/chapter2/shaders/source1_fragment.glsl");
